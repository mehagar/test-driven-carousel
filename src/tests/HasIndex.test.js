...
describe('HasIndex()', () => {
  ...
  it('always has the index` state equal to the `index` prop', () => {
  ...
  it('calls on `onIndexChange` on decrement/increment', () => {
  ...
  it('as the min `index` state on increment from the max', () => {
